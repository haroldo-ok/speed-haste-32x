...
| Standard MegaDrive ROM header at 0x100
        ...
        .ascii  "SEGA 32X        "      /* SEGA must be the first four chars for TMSS */
        .ascii  "(C)AREVALO 2026 "
        .ascii  "SPEED HASTE     "      /* domestic name */
        .ascii  "32X PORT        "
        .ascii  "                "
        .ascii  "SPEED HASTE     "      /* export name */
        .ascii  "32X PORT        "
        .ascii  "                "
        .ascii  "GM SH32X001-00"
